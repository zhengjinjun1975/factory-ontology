#!/usr/bin/env python3
"""e2e_test.py — factory-ontology v0.1.3 端到端测试
...
def main():
    ...
    import run
    ck("版本 0.1.3", run.__version__ == "0.1.3")
